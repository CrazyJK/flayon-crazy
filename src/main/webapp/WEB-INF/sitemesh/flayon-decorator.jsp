...
<script type="text/javascript" src="<c:url value="/js/flayon.common.js"           />"></script>
<script type="text/javascript" src="<c:url value="/js/flayon.effect.aperture.js"  />"></script>
<script type="text/javascript" src="<c:url value="/js/flayon.effect.jquery-ui.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/flayon.effect.typed.js"     />"></script>
