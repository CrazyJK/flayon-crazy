...
<nav id="img-nav">
	<table>
		...
		<tr>
			...
			<td>
				<a class="moveBtn" onclick='imgScrollLeft()' title="Move left"><span class="glyphicon glyphicon-arrow-left"></span></a>
				<a class="moveBtn" onclick='imgScrollRight()' title="Move right"><span class="glyphicon glyphicon-arrow-right"></span></a>
				<a class="moveBtn" onclick='imgScrollUp()' title="Move up; Numpad 8"><span class="glyphicon glyphicon-arrow-up"></span></a>
				<a class="moveBtn" onclick='imgScrollDown()' title="Move down; Numpad 2"><span class="glyphicon glyphicon-arrow-down"></span></a>
				<a class="moveBtn" onclick='imgPlus()' title="Magnify; Numpad +"><span class="glyphicon glyphicon-plus"></span></a>
				<a class="moveBtn" onclick='imgNinus()' title="Curtail; Numpad -"><span class="glyphicon glyphicon-minus"></span></a>
