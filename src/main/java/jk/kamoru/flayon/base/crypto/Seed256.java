...
public class Seed256 implements Crypto {
	...
	private void SeedRoundKey (int pdwRoundKey[], byte pbUserKey[]) {
		int A[] = new int[1];
		int B[] = new int[1];
		int C[] = new int[1];
		int D[] = new int[1];
	...
	private byte[] seedEncrypt(byte[] password) {
	...
	private byte[] seedEncrypt (String password) {
	...
	public String decrypt(String hash) {
		try {
			...
			throw new FlayOnException("SEED256 decryption error", e);
		}
	}
	...
	public String encrypt(String password) {
		...
		//		byte[] encodeBase64 = Base64.encodeBase64(result);
			...
			throw new FlayOnException("SEED256 encryption error", e);
		}
	}
